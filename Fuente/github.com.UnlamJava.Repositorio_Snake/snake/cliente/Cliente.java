...
public class Cliente {
	...
	public Cliente() {
		 ...
		 * 
		 * // VentanaLogeo - Validar usuario - aca se puede mostrar una ventana para el
		 * logeo // y con el objecto conn enviar al sv el usuario y la pass
		 * 
		 ...
		 * 
		 * 
		 * // iniciarJuego(); se ejecuta al tocar el boton entrar - enrealidad se
		 * ejecuta // cuando el server diga que la sala esta lista para empezar.
		 * this.iniciarJuego();
		 */
	}

	public void conectarASerivodor() {
		// Inicializo sockets
		this.ip = "localhost";
		this.port = 10000;
		try {
	...
	private void iniciarJuego() {
		...
		// Sale de iniciar cuando terminen las rondas, muera, salga a voluntad, u otro
		// criterio.
	...
	public static void main(String[] args) {
		...
		new Cliente(); // Me conecto al server
